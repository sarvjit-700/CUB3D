...
/*   Updated: 2026/02/23 23:03:59 by ssukhija         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    move_player(t_map_data *data)
{
    ...
    {
        if (data->grid[(int)data->player.y][(int)(data->player.x + data->player.dir_x * move_speed)] == '0')
            data->player.x += data->player.dir_x * move_speed;
        if (data->grid[(int)(data->player.y + data->player.dir_y * move_speed)][(int)data->player.x] == '0')
...
void    strafe_player(t_map_data *data)
{
    ...
    {
        if (data->grid[(int)data->player.y][(int)(data->player.x - data->player.dir_y * move_speed)] == '0')
            data->player.x -= data->player.dir_y * move_speed;
        if (data->grid[(int)(data->player.y + data->player.dir_x * move_speed)][(int)data->player.x] == '0')
